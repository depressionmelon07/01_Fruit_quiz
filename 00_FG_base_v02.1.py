""" PROGRAM DESC************
Program is a full Fruit_Quiz game for 5-11 year olds.
Program displays instructions if user has not played game before.
There is a maximum of 10 rounds.
To select answers users use the number keys 1, 2, 3, and 4.
V2.1 - full game with all components (7) + program description.
Pari Rao 29/09/22
PROGRAM DESC**************"""
